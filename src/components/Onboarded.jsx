                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                            {notes.proofOfConcept && notes.proofOfConcept !== 'Not started' && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.proofOfConcept}</p>
                              </div>
                            )}
                            {notes.prototypeDevelopment && notes.prototypeDevelopment !== 'Not started' && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.prototypeDevelopment}</p>
                              </div>
                            )}
                            {notes.productDevelopment && notes.productDevelopment !== 'Not started' && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.productDevelopment}</p>
                              </div>
                            )}
                            {notes.fieldTrials && notes.fieldTrials !== 'Not started' && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                <span className="text-gray-600 dark:text-gray-400">Field Trials:</span>
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.fieldTrials}</p>
                              </div>
                            )}
                            {notes.marketLaunch && notes.marketLaunch !== 'Not started' && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                <span className="text-gray-600 dark:text-gray-400">Market Launch:</span>
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.marketLaunch}</p>
                              </div>
                            )}
                          </div>
                        )}
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                            {notes.numberOfEmployees && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.numberOfEmployees}</p>
                              </div>
                            )}
                            {notes.ipRegistrations && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                <span className="text-gray-600 dark:text-gray-400">IP Registrations:</span>
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.ipRegistrations}</p>
                              </div>
                            )}
                            {notes.gemPortalProducts && (
                              <div className="bg-white dark:bg-gray-700 p-2 rounded">
                                <span className="text-gray-600 dark:text-gray-400">GEM Products:</span>
                                <p className="font-semibold text-gray-900 dark:text-white">{notes.gemPortalProducts}</p>
                              </div>
                            )}
                          </div>
                        )}
