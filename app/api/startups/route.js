...
const transformToDb = (body) => ({
  ...
  // Handle both socialMedia and socialMediaPlatform (from import)
  socialMedia: body.socialMedia || body.socialMediaPlatform,
  founderAge: parseInt(body.founderAge) || null,
  founderGender: body.founderGender,
  college: body.college,
  address: body.address,
  referredFrom: body.referredFrom || body.registrationReferredFrom,
